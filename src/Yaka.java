...
/**************************************/
  static final public void prog() throws ParseException {
    ...
    jj_consume_token(FPROGRAMME);
                 yvm.queue(); System.out.println(declaration);
  }
  ...
  static final public void bloc() throws ParseException {
    ...
    while (true) {
      ...
      declVar();
               ...
               yvm.ouvrePrinc(declaration.offset / -2);
    suiteExpr();
  }
...
/*void bloc() : {}{
 ...
 (declVar())* {yvm.ouvrePrinc(declaration.offset / -2);}
  ...
  static final public void valConst() throws ParseException {
    ...
    case entier:
      jj_consume_token(entier);
             declaration.createConstInt(YakaTokenManager.entierLu, token.beginLine);
      break;
    case ident:
      jj_consume_token(ident);
             declaration.createConstVar(YakaTokenManager.identLu, token.beginLine);
      break;
    case VRAI:
      jj_consume_token(VRAI);
             declaration.createConstBool(TRUE, token.beginLine);
      break;
    case FAUX:
      jj_consume_token(FAUX);
             declaration.createConstBool(FALSE, token.beginLine);
      break;
    default:
      jj_la1[3] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public void declVar() throws ParseException {
    ...
    type();
    jj_consume_token(ident);
            declaration.createVar(YakaTokenManager.identLu, token.beginLine);
    label_4:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case 40:
 ...
 */
  ...
  static final public void valeur() throws ParseException {
    ...
    case ident:
      jj_consume_token(ident);
              expression.ajoutTypeFromVar(YakaTokenManager.identLu, token.beginLine); declaration.appelConst(YakaTokenManager.identLu,token.beginLine);
      break;
    case VRAI:
      jj_consume_token(VRAI);
  ...
  static final public void opAdd() throws ParseException {
    ...
    case OU:
      jj_consume_token(OU);
                   expression.ajoutOp(eOperande.OU);
      break;
    default:
      jj_la1[16] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public void opMul() throws ParseException {
    ...
    case ET:
      jj_consume_token(ET);
                   expression.ajoutOp(eOperande.ET);
      break;
    default:
      jj_la1[17] = jj_gen;
      jj_consume_token(-1);
